<div class="mo" id="m-med"><div class="mbox">
<div class="mh"><div class="mt2">📐 Medição</div><button class="mc" onclick="closeM('m-med')">×</button></div>
...
<div class="fr"><div class="fg" id="med-ct-wrap"><label>Contrato</label><select id="med-ct" onchange="autoFillMed();numMedicaoAuto()"><option value="">Selecionar...</option></select></div><div class="fg" id="med-placa-man-wrap" style="display:none"><label>Placa autorizada</label><select id="med-placa-man" onchange="autoFillMedMan()"><option value="">Selecionar placa autorizada...</option></select></div><div class="fg"><label>Nº da Medição <span style="font-size:10px;color:var(--mt)">(automático pelo contrato)</span></label>
<input id="med-num" placeholder="Selecione o contrato" readonly="" style="background:var(--cd2);font-weight:700"/>
</div>
<div class="fg"><label>Mês Ref.</label><input id="med-ms" type="month"/></div></div>
<div class="fr"><div class="fg"><label>Período De</label><input id="med-de" type="date"/></div><div class="fg"><label>Período Até</label><input id="med-at" type="date"/></div></div>
<div class="fr"><div class="fg"><label>Horas Medidas</label><input id="med-hr" placeholder="200" type="number"/></div><div class="fg"><label>Horas Extras (h)</label><input id="med-he" oninput="calcMed()" type="number" value="0"/></div></div>
<div class="fr"><div class="fg"><label>Valor Base (R$)</label><input id="med-vl" oninput="calcMed()" type="number"/></div><div class="fg"><label>Valor H.Extra (R$/h)</label><input id="med-vhe" oninput="calcMed()" type="number" value="0"/></div></div>
...
<div class="fr"><div class="fg"><label>Vencimento</label><input id="med-vc" type="date"/></div><div class="fg"><label>Status</label><select id="med-st"><option value="pendente">Pendente</option><option value="enviada">Enviada</option><option value="aprovada">Aprovada</option></select>
<p style="font-size:10px;color:var(--mt);margin-top:4px">ℹ️ Aprovada → entra automático em Contas a Receber e Fluxo de Caixa. Recebimento é confirmado pelo Financeiro.</p></div></div>
</div>
