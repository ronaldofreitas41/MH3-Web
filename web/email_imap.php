...
$pastaImap = $pasta;
if (function_exists('mb_convert_encoding')) { $tmp = @mb_convert_encoding($pasta, 'UTF7-IMAP', 'UTF-8'); if ($tmp !== false && $tmp !== '') $pastaImap = $tmp; }
$mbox = @imap_open($ref.$pastaImap, $login, $senha, 0, 1);
if (!$mbox) {
