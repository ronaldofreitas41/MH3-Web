<div class="page" id="pg-whatsapp">
  ...
  <div class="panel" style="margin-bottom:14px;border:2px solid #25D366">
    <div class="ph">
      <div class="pt">📱 Número da empresa</div><button class="btn btn-sm" onclick="salvarWaNumero()" style="background:#25D366;color:#fff;border:none">💾 Salvar</button>
    </div>
    <div class="pb">
      <div class="fg"><label>Número de WhatsApp da empresa (será usado na Fase 2)</label><input id="wa-empresa-num" placeholder="(31) 90000-0000" /></div>
    </div>
  </div>
  <div class="panel" style="margin-bottom:14px">
    <div class="ph">
      <div class="pt">✉️ Enviar mensagem</div>
    </div>
    <div class="pb">
      <div class="fr">
        <div class="fg"><label>Para qual número?</label><input id="wac-tel" placeholder="(00) 00000-0000" /></div>
        <div class="fg"><label>Ou escolher cliente cadastrado</label><select id="wac-cli" onchange="if(this.value)document.getElementById('wac-tel').value=this.value">
            <option value="">— escolher cliente —</option>
          </select></div>
      </div>
      <div class="fg"><label>Usar uma mensagem pronta</label><select id="wac-pronta" onchange="waUsarPronta(this.value)">
          <option value="">— escolher mensagem pronta —</option>
        </select></div>
  ...
  <div class="panel" style="margin-bottom:14px">
    <div class="ph">
      <div class="pt">📝 Mensagens já prontas</div><button class="btn bp btn-sm" onclick="waProntaNova()">➕ Nova mensagem</button>
    </div>
    <div class="pb">
      <p style="font-size:11px;color:var(--mt);margin-bottom:10px">Cadastre mensagens que você usa sempre (cobrança, agendamento de revisão, aviso de medição, etc.) para escolher rapidinho na hora de enviar.</p>
      <div id="wa-prontas-list"></div>
    </div>
  </div>
  <div class="panel" style="margin-bottom:14px">
    <div class="ph">
      <div class="pt">⚙️ Mensagens automáticas por tela</div><button class="btn btn-sm" onclick="salvarWaMsgs()" style="background:#25D366;color:#fff;border:none">💾 Salvar</button>
    </div>
    <div class="pb">
