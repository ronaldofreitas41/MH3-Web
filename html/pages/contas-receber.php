...
<div class="panel">
<div class="ph"><div class="pt">💵 Contas a Receber</div><button class="btn bw btn-sm no-print" onclick="abrirImportacao('contas_receber')" style="margin-left:auto" title="Importar planilha CSV">📥 Importar</button><button class="btn bd btn-sm no-print" onclick="limparModulo('contas_receber')" title="Apagar TODOS os dados desta aba (somente admin)">🗑 Limpar Tudo</button></div>
<div class="tw"><table>
<thead><tr><th>Cliente</th><th>Origem</th><th>Valor</th><th>Venc.</th><th>Placa</th><th>Situação</th></tr></thead>
