<div class="page" id="pg-relatorios">
    <div class="panel" style="margin-bottom:12px">
        <div class="ph">
            <div class="pt">📅 Relatório Analítico por Período</div>
        </div>
        <div class="pb">
            <div class="fr">
    ...
    <div class="panel" style="margin-bottom:12px">
        <div class="ph">
            <div class="pt">📊 Relatórios Gerenciais</div>
        ...
        <div class="pb">
            ...
            <div id="relg-resultado" style="margin-top:10px">
                <p style="font-size:12px;color:var(--mt)">Escolha o tipo e clique em Gerar.</p>
            </div>
        </div>
    </div>
    <div class="panel" style="margin-bottom:12px">
        <div class="ph">
            <div class="pt">🚛 Relatório Patrimonial da Frota (Analítico)</div>
            <div style="display:flex;gap:8px">
        ...
        <div class="pb">
            <div id="relf-resultado">
                <p style="font-size:12px;color:var(--mt)">Clique em Gerar para ver todos os veículos/equipamentos com data de levantamento, valor de quitação, valor atualizado e parcelas que faltam.</p>
            </div>
        </div>
    </div>
    ...
    <div style="background:var(--cd);border:1px solid var(--br);border-radius:8px;padding:12px 16px;margin-bottom:14px;display:flex;flex-wrap:wrap;gap:10px;align-items:center;">
        <div style="display:flex;flex-direction:column;gap:2px"><label style="font-size:9px">Período</label><select id="rel-periodo" onchange="rdRelAtivo()" style="width:auto">
    ...
    <div class="tab-p" id="tr-receitas">
        <div id="rel-receitas"></div>
    </div>
    <div class="tab-p" id="tr-desp">
        <div id="rel-desp"></div>
    </div>
    <div class="tab-p" id="tr-frota">
        <div id="rel-frota-c"></div>
    </div>
    <div class="tab-p" id="tr-cli">
        <div id="rel-cli"></div>
    </div>
    <div class="tab-p" id="tr-estq">
        <div id="rel-estq-c"></div>
    </div>
    <div class="tab-p" id="tr-manut">
        <div id="rel-manut-c"></div>
    </div>
    <div class="tab-p" id="tr-contratos">
        <div id="rel-contratos-c"></div>
    </div>
    <div class="tab-p" id="tr-fluxo2">
        <div id="rel-fluxo2-c"></div>
    </div>
    <div class="tab-p" id="tr-cpagar">
        <div id="rel-cpagar-c"></div>
    </div>
    <div class="tab-p" id="tr-creceber">
        <div id="rel-creceber-c"></div>
    </div>
    <div class="tab-p" id="tr-resplaca">
        <div id="rel-resplaca-c"></div>
    </div>
    <div class="tab-p" id="tr-resgeral">
        <div id="rel-resgeral-c"></div>
    </div>
</div>