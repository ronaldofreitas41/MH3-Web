<div class="page" id="pg-tratativas">
    ...
    <div class="krow c3">
        <div class="kpi yw">
            <div class="klbl">Pendentes</div>
            <div class="kval" id="trat-pend">0</div>
            <div class="ksub">a resolver</div>
        </div>
        <div class="kpi gn">
            <div class="klbl">Resolvidas</div>
            <div class="kval" id="trat-resolv">0</div>
            <div class="ksub">concluídas</div>
        </div>
        <div class="kpi cy">
            <div class="klbl">Total</div>
            <div class="kval" id="trat-total">0</div>
            <div class="ksub">tratativas</div>
        </div>
    </div>
