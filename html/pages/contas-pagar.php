...
<div class="panel">
<div class="ph"><div class="pt">💸 Contas a Pagar</div><button class="btn bw btn-sm no-print" onclick="abrirImportacao('contas_pagar')" style="margin-left:auto" title="Importar planilha CSV">📥 Importar</button><button class="btn bd btn-sm no-print" onclick="limparModulo('contas_pagar')" title="Apagar TODOS os dados desta aba (somente admin)">🗑 Limpar Tudo</button></div>
<div class="tw"><table>
<thead><tr><th>Descrição</th><th>Tipo</th><th>Fornecedor</th><th>Vencimento</th><th>Valor</th><th>Status</th><th>Ação</th></tr></thead>
