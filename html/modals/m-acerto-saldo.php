<div class="mo" id="m-acerto-saldo">
    <div class="md">
        <div class="mh">
            <div class="mt2">⚖️ Acerto de Saldo</div><button class="x" onclick="closeM('m-acerto-saldo')">×</button>
        </div>
        <div class="mb">
            ...
            <div class="fg"><label>Qual saldo ajustar?</label><select id="as-qual" onchange="_acertoTrocaQual()">
                    <option value="saldo">Saldo corrente</option>
                    <option value="saldoPA">Saldo poupança / aplicação</option>
                </select></div>
