<div class="mo" id="m-rev"><div class="mbox">
<div class="mh"><div class="mt2">🔄 Lançar KM / Horímetro</div><button class="mc" onclick="closeM('m-rev')">×</button></div>
...
<div class="fr"><div class="fg"><label>KM Atual</label><input id="rev-km" type="number"/></div><div class="fg"><label>Horímetro Atual (h)</label><input id="rev-hr" type="number"/></div></div>
