<div class="mo" id="m-tratativa">
    <div class="mbox">
        <div class="mh">
            <div class="mt2" id="trat-mtitle">🤝 Nova Tratativa</div><button class="mc" onclick="closeM('m-tratativa')">×</button>
        </div>
        <div class="mb2">
            ...
            <div class="fg"><label>Veículo / Placa <span style="font-size:10px;color:var(--mt)">(da lista ou digite manual)</span></label>
                <select id="trat-veic-sel" onchange="tratVeicTrocar(this.value)" style="margin-bottom:6px">
                    <option value="">— Selecionar placa cadastrada —</option>
                    <option value="__manual__">✏️ Outro (digitar manual)</option>
                </select>
            ...
            <div class="fr">
                ...
                <div class="fg"><label>Status</label><select id="trat-st">
