<div class="mo" id="m-cl">
    <div class="mbox">
        <div class="mh">
            <div class="mt2">☑️ Checklist</div><button class="mc" onclick="closeM('m-cl')">×</button>
        </div>
        <div class="mb2">
            <input id="cl-eid" type="hidden" />
            <div class="fr">
                <div class="fg"><label>Nome</label><input id="cl-nm" placeholder="Ex: Mobilização Passo I" /></div>
                <div class="fg"><label>Categoria</label><select id="cl-cat">
