<div class="mo" id="m-estq">
    <div class="mbox lg">
        <div class="mh">
            <div class="mt2" id="estq-mtitle">📦 Produto / Peça</div><button class="mc" onclick="closeM('m-estq')">×</button>
        </div>
        <div class="mb2"><input id="estq-eid" type="hidden" />
            ...
            <div class="tab-p on" id="testq-dados">
                ...
                <div class="fr3">
                    ...
                    <div class="fg"><label>Unidade</label><select id="estq-un">
                            <option>UN</option>
                            <option>L</option>
                            <option>KG</option>
                            <option>MT</option>
