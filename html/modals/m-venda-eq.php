<div class="mo" id="m-venda-eq">
    <div class="mbox">
        <div class="mh">
            <div class="mt2">💰 Venda de Veículo/Equipamento/Implemento</div><button class="mc" onclick="closeM('m-venda-eq')">×</button>
        </div>
        <div class="mb2">
            ...
            <div class="fr">
                <div class="fg"><label>Forma de Pagamento</label><select id="veq-pag">
                        <option>À Vista</option>
                        <option>PIX</option>
                        <option>Financiado</option>
                        <option>Troca/Permuta</option>
                    </select></div>
                <div class="fg"><label>Status Recebimento</label><input id="veq-st" readonly="" style="background:var(--cd2);color:var(--mt);font-size:12px" value="Pendente (Financeiro confirma)" /></div>
                <div style="display:none"><input id="veq-st-val" type="hidden" value="pendente" /></div>
            </div>
        </div>
