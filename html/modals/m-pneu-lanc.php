<div class="mo" id="m-pneu-lanc">
    <div class="mbox">
        <div class="mh">
            <div class="mt2">✏️ Editar Lançamento</div><button class="mc" onclick="closeM('m-pneu-lanc')">×</button>
        </div>
        <div class="mb2">
            ...
            <div class="fr">
                ...
                <div class="fg"><label>Tipo</label><select id="lanc-tipo">
